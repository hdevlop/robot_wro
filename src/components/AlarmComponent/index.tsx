...
export const AlarmComponent = () => {
    ...
    // Auto-open dialog when alarms are detected
    useEffect(() => {
    ...
    const hasWarnings = activeThresholds.some(alarm => alarm.severity === 'warning');
            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-4">
                    ...
                    <div className="border rounded-lg p-4 bg-muted/50">
                        <h3 className="font-semibold text-sm mb-3">Current Sensor Readings</h3>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="space-y-1">
                                <p className="text-sm text-muted-foreground">Temperature</p>
                                <p className="font-mono text-lg">{sensors.temperature}°C</p>
                            </div>
                            <div className="space-y-1">
                                <p className="text-sm text-muted-foreground">Humidity</p>
                                <p className="font-mono text-lg">{sensors.humidity}%</p>
                            </div>
                            <div className="space-y-1">
                                <p className="text-sm text-muted-foreground">CO Level</p>
                                <p className="font-mono text-lg">{sensors.co} ppm</p>
                            </div>
                            <div className="space-y-1">
                                <p className="text-sm text-muted-foreground">Air Quality</p>
                                <p className="font-mono text-lg">{sensors.airQuality}</p>
                            </div>
                        </div>
                    </div>
